...
#from solutions.random_walk_solution import generate_random_walk, analyze_walks_statistics, compare_mean_squared_displacement
from src.random_walk import generate_random_walk, analyze_walks_statistics, compare_mean_squared_displacement
...
def test_analyze_walks_statistics():
    ...
    # 运行分析函数
    msd = analyze_walks_statistics(num_walks, num_steps)
