...
def test_calculate_poisson_pmf():
    ...
    pmf = rare_events.calculate_poisson_pmf(l_values, lambda_val=1)
    ...
    pmf = rare_events.calculate_poisson_pmf(l_values, lambda_val=8)
...
def test_simulate_coin_flips():
    ...
    # 运行模拟
    heads_count = rare_events.simulate_coin_flips(N, n, p)
...
def test_analyze_waiting_times():
    ...
    # 运行分析
    waiting_times = rare_events.analyze_waiting_times(num_flips, p)
